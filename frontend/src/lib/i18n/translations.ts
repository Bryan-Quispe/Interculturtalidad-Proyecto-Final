...
export const dict = {
  ...
  'home.viewDetail': ['Ver ficha completa →', 'Tukuy willayta rikuna →'],
  'home.lostBadge': ['Se busca', 'Maskanakun'],
  'home.distance': ['a {km} km', '{km} km karupi'],
  'home.model3d': ['Modelo 3D con sus señas', '3D rikchak, unanchakunawan'],
  'home.model3dHint': [
    'Arrastra para girar el modelo y usa la rueda del ratón para acercarlo.',
    'Muyuchinkapak aysay, kuchuyachinkapak ukucha muyuta mutsuy.',
  ],
  'home.ownerLabel': ['Propietario:', 'Amu:'],
